...
export default function NavLink1({ href, active, children }) {
    return (
        <Link
            ...
            className={
                active
                    ? 'inline-flex items-center text-decoration-none px-1 pt-1 text-sm font-md leading-4 text-amber-600 hover:text-amber-300 transition duration-150 ease-in-out'
