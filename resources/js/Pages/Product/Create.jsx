                        ...
                        <form className="mt-6 space-y-6" onSubmit={onSaveHandler}>
                            ...
                            <div>
                                <div className="mt-6">
                                    ...
                                    <textarea id="prod_description" cols="15" rows="10" name="prod_description" className="mt-1 block w-full" onChange={handleChange} />
                                </div>
                            </div>
                            <div className='grid grid-cols-2 gap-3'>
                                <div>
                                    <div className="mt-6">
                                        ...
                                        <TextInput type="number" id="invent_quantity"
                                            name="invent_quantity"
                                ...
                                <div>
                                    <div className="mt-6">
                                        ...
                                        <TextInput data-type="currency"
                                            min="0" max="10000"
                                            step="0.01" id="invent_price"
                                            name="invent_price"
                                            className="mt-1 block w-full"
                                            handleChange={handleChange} />
                                    </div>
