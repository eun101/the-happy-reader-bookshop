            ...
            <div id="legacy">
                ...
                <div id="company-objectives" className="row">
                    <div id="mission-content" className="col-md-6">
                        ...
                        <img id="mission" src="https://the-happy-reader-bookshop.s3.ap-southeast-1.amazonaws.com/capstone+assets/missionfin.png" className="mx-auto w-1/3" />
                        <br />
                    ...
                    <br/>
                        <p className='text-center text-gray-100'>  To create a community of readers and writers who share the same passion for books.          
                        </p>
                </div>
                    <br/>
                </div>
