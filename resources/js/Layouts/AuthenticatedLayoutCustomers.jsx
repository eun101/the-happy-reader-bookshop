                ...
                <nav className={` ${(open ? 'hidden' : 'block') + ' lg:block'} sticky text-medium  left-0 top-0 bottom-0 h-98  p-5 bg-neutral-200 shadow duration-300`}>
                    ...
                    <div>
                        <div className="pt-4 space-y-2 ">
                            <div>
                                <NavLink1 href={route('dashboard-display.index')} active={route().current('dashboard.index')}>
                                    <span className='text-xl'>Account Dashboard</span>
                                </NavLink1>
                            </div>
                            <div>
                                <NavLink1 href={route('my-orders.index')} active={route().current('my-orders.index')}>
                            ...
                            <div>
                                <NavLink1 href={route('profile.edit')} active={route().current('profile.edit')}>
                                    <span className='text-xl'>
                                        Account Information
                                    </span>
                                </NavLink1>
