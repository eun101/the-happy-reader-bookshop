...
export default function Guest({ children }) {
    return (
        <div className="">
                <nav className={` ${(open ? 'hidden' : 'block') + ' lg:block' }  bg-yellow-400 text-gray-900 shadow-lg navbar navbar-expand-lg navbar-light`}>
                <Link href="/">
                ...
                <div className='shrink-0 flex items-right mx-auto sticky'>
                    ...
                    <div className=" space-x-12 flex top-0 mx-auto">
