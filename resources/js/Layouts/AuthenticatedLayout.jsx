...
export default function Authenticated({ auth, header, children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex">
            <nav className={` ${(open ? 'hidden' : 'block') + ' lg:block' } text-medium border-neutral-800 left-0 top-0 bottom-0 h-100 fixed flex-col-6 h-screen p-4 bg-neutral-800 shadow duration-300 font-bold`}>
                ...
                <div className='shrink-0 flex items-right mx-auto'>
                    ...
                    <button
                            ...
                            >
                                ...
                                <svg className="h-6 w-6 z-100" stroke="white" fill="none" viewBox="">
                                    <path
                            ...
                            <NavLink href={route('orders.index')} active={route().current('orders.index')}>
                                ...
                                >
                                    <path
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                        d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z text-white"
                                    />
                                </svg>
